...
import NoBlogsFallback from '@/components/NoBlogsFallback';
          ...
          <div className="py-5 px-6">
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-1">
                <h2 className="font-mono text-base group-hover:text-primary transition-colors">
                  {post.title}
                </h2>
                <p className="text-sm text-muted-foreground/80">{post.excerpt}</p>
              </div>
...
const Blog = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto px-6 py-6">
        <div className="space-y-8">
          ...
          <NoBlogsFallback 
            message="No posts found matching the selected tags." 
  ...
  return (
    <div className={cn(
      "mx-auto px-6",
      isMinimal ? "max-w-3xl py-12" : "max-w-4xl py-6"
    )}>
      <div className="space-y-8">
        <header className={cn(
          "space-y-4",
          ...
          <h1 className={cn(
            isMinimal 
              ? "text-2xl font-mono" 
              : "text-4xl sm:text-5xl font-bold gradient-text"
          )}>
            Blog Posts
          </h1>
          {!isMinimal && (
